    ...
    testResult: {
      ...
      testData: {
        ...
        drivingFaults: {
          ...
          rearObservationSignalling: 12,
          rearObservationSignallingComments: 'rearObservationSignallingComments',
          rearObservationChangeDirection: 13,
          rearObservationChangeDirectionComments: 'rearObservationChangeDirectionComments',
          rearObservationChangeSpeed: 14,
          rearObservationChangeSpeedComments: 'rearObservationChangeSpeedComments',
          signalsNecessary: 15,
          ...
          judgementOvertakingFiltering: 23,
          judgementOvertakingFilteringComments: 'judgementOvertakingFilteringComments',
          judgementMeeting: 24,
          judgementMeetingComments: 'judgementMeetingComments',
          judgementCrossing: 25,
          judgementCrossingComments: 'judgementCrossingComments',
          positionNormalRiding: 26,
          positionNormalRidingComments: 'positionNormalRidingComments',
...
export function getFaultsByOutcomeSeverity(severityText: String) {
  return {
    ...
    rearObservationSignalling: 1,
    rearObservationSignallingComments: `rearObservationSignalling ${severityText}`,
    rearObservationChangeDirection: 1,
    rearObservationChangeDirectionComments: `rearObservationChangeDirection ${severityText}`,
    rearObservationChangeSpeed: 1,
    rearObservationChangeSpeedComments: `rearObservationChangeSpeed ${severityText}`,
    signalsNecessary: 1,
    ...
    judgementOvertakingFiltering: 1,
    judgementOvertakingFilteringComments: `judgementOvertakingFiltering ${severityText}`,
    judgementMeeting: 1,
    judgementMeetingComments: `judgementMeeting ${severityText}`,
    judgementCrossing: 1,
    judgementCrossingComments: `judgementCrossing ${severityText}`,
    positionNormalRiding: 1,
    positionNormalRidingComments: `positionNormalRiding ${severityText}`,
