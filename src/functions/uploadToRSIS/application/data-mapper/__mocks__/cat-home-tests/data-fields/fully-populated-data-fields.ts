...
export function getCatHomeTestsDrivingFaultDataFields(): DataField[] {
  return [
...
export function getCatHomeTestsFullyPopulatedSeriousDataFields(): DataField[] {
  return [
    { col: 'AUTOMATIC_TEST', val: 0 },
    { col: 'H_CODE_SAFETY_TOTAL', val: 0 },
    { col: 'H_CODE_SAFETY_SERIOUS', val: 1 },
    { col: 'H_CODE_SAFETY_COMMENT', val: 'highwaycode safety S' },
    { col: 'CONTROL_STOP_PROMPT_COMMENT', val: 'controlled stop S' },
...
export function getCatHomeTestsFullyPopulatedDangerousDataFields(): DataField[] {
  return [
    { col: 'AUTOMATIC_TEST', val: 0 },
    { col: 'H_CODE_SAFETY_TOTAL', val: 0 },
    { col: 'H_CODE_SAFETY_SERIOUS', val: 0 },
    { col: 'H_CODE_SAFETY_COMMENT', val: 'highwaycode safety D' },
    { col: 'CONTROL_STOP_PROMPT_COMMENT', val: 'controlled stop D' },
    { col: 'REV_LEFT_TRAIL_CONT_TOTAL', val: 0 },
    { col: 'REV_LEFT_TRAIL_OBSERV_TOTAL', val: 0 },
    { col: 'PRECAUTIONS_TOTAL', val: 0 },
    { col: 'CONTROL_ACC_TOTAL', val: 0 },
