...
import { getMinimalInput } from '../__mocks__/cat-ce/inputs/minimal-inputs';
import { getCatCEMinimalDataFields } from '../__mocks__/cat-ce/data-fields/minimal-data-fields';
import {
  getFullyPopulatedDrivingFaults,
  getFullyPopulatedSeriousFaults,
  getFullyPopulatedDangerousFaults,
} from '../__mocks__/cat-ce/inputs/fully-populated-inputs';
import {
  getCatCEFullyPopulatedSeriousDataFields,
  getCatCEFullyPopulatedDangerousDataFields,
} from '../__mocks__/cat-ce/data-fields/fully-populated-data-fields';
...
describe('mapCatC1EData', () => {
  ...
  it('Should map a minimally populated test result (test terminated early as possible)', () => {
    const minimalInput = getMinimalInput(TestCategory.C1E);
  ...
  it('Should map a fully populated regular test result (every possible driving fault)', () => {
    const fullyPopulated = getFullyPopulatedDrivingFaults(getMinimalInput(TestCategory.C1E));
  ...
  it('Should map a fully populated regular test result (every possible serious fault)', () => {
    const fullyPopulated = getFullyPopulatedSeriousFaults(getMinimalInput(TestCategory.C1E));
  ...
  it('Should map a fully populated regular test result (every possible dangerous fault)', () => {
    const fullyPopulated = getFullyPopulatedDangerousFaults(getMinimalInput(TestCategory.C1E));
