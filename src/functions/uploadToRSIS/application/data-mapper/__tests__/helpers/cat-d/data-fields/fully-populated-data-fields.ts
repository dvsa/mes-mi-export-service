...
export function getCatDFullyPopulatedSeriousDataFields(): DataField[] {
  return [
    ...
    { col: 'CONTROL_PCV_DOOR_COMMENT', val: 'pcv door exercise controls serious' },
...
export function getCatDFullyPopulatedDangerousDataFields(): DataField[] {
  return [
    ...
    { col: 'CONTROL_PCV_DOOR_COMMENT', val: 'pcv door exercise controls dangerous' },
