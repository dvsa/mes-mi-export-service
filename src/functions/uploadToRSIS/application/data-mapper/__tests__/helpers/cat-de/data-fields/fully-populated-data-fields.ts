...
export function getCatDEFullyPopulatedSeriousDataFields(): DataField[] {
  return [
    ...
    { col: 'CONTROL_PCV_DOOR_SERIOUS', val: 1 },
    ...
    { col: 'CONTROL_PCV_DOOR_COMMENT', val: 'psv door exercise controls serious' },
...
export function getCatDEFullyPopulatedDangerousDataFields(): DataField[] {
  return [
    ...
    { col: 'CONTROL_PCV_DOOR_DANGEROUS', val: 1 },
    ...
    { col: 'CONTROL_PCV_DOOR_COMMENT', val: 'psv door exercise controls dangerous' },
