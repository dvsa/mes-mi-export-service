...
export const mapCatADI3Data = (result: ResultUpload): DataField[] => {
  ...
  const mappedFields: DataField[] = [
    ...
    // @TODO - confirm if new value needed
    // field('FORM_TYPE', FormType.ADI3),
    ...
    // Communication
    addIfSet(mappedFields, 'COMMUNICATION_METHOD', optional(testResult, 'communicationPreferences.communicationMethod', null)),
  ...
  // ADI3 optional fields for Candidate/trainer
  addIfSet(mappedFields, 'CANDIDATE_FORENAMES', optional(testResult, 'journalData.candidate.candidateName.firstName', null));
